...
public class UserServiceUnitTest
{
	...
	{
		Mockito.when(this.repo.save(TEST_USER)).thenReturn(TEST_USER);
		
		UserDto sut = this.service.addUser(TEST_USER);
		
		Assertions.assertThat(sut).usingRecursiveComparison().isEqualTo(TEST_USER);
	}
}
